...
public class FeedbackResponseCommentsLogicTest extends BaseLogicTest {
    ...
    public void testIsResponseCommentVisibleForUser() {
        ...
        EntityAttributes<FeedbackQuestion> relatedQuestion = dataBundle.feedbackQuestions.get("qn1InSession1InCourse1");
    ...
    private String getQuestionIdInDataBundle(String questionInDataBundle) {
        EntityAttributes<FeedbackQuestion> question = dataBundle.feedbackQuestions.get(questionInDataBundle);
