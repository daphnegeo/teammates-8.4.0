...
public class AdminSearchPageE2ETest extends BaseE2ETestCase {
    ...
    public void testAll() {
        ...
        EntityAttributes<Account> studentAccount = testData.accounts.get("student1InCourse1");
        InstructorAttributes instructor = testData.instructors.get("instructor1OfCourse1");
        EntityAttributes<Account> instructorAccount = testData.accounts.get("instructor1OfCourse1");
