...
public abstract class RankOptionSuper extends AppPage {
	...
	public RankOptionSuper(Browser browser) {
		super(browser);
	}
	...
	public void verifyQuestionDetails(int questionNum, FeedbackQuestionsVariousAttributes question) {
	...
	public void verifyResponseDetails(FeedbackQuestionsVariousAttributes question, List<FeedbackResponseAttributes> givenResponses, List<FeedbackResponseAttributes> otherResponses, Set<String> visibleGivers, Set<String> visibleRecipients) {
	...
	private boolean hasDisplayedResponses(FeedbackQuestionsVariousAttributes question) {
	    return !question.getQuestionDetailsCopy().getQuestionType().equals(FeedbackQuestionType.CONTRIB);
	}

	private void verifyGivenResponses(FeedbackQuestionsVariousAttributes question, List<FeedbackResponseAttributes> givenResponses) {
	...
	private void verifyOtherResponses(FeedbackQuestionsVariousAttributes question, List<FeedbackResponseAttributes> otherResponses, Set<String> visibleGivers, Set<String> visibleRecipients) {
	...
	private void verifyResponseForRecipient(FeedbackQuestionsVariousAttributes question, String recipient, List<FeedbackResponseAttributes> otherResponses, Set<String> visibleGivers, Set<String> visibleRecipients) {
	...
	private void verifyAnonymousResponseView(FeedbackQuestionsVariousAttributes question, List<FeedbackResponseAttributes> expectedResponses, boolean isGiverVisible) {
	...
	private boolean isResponseEqual(FeedbackQuestionsVariousAttributes question, WebElement responseField, FeedbackResponseAttributes response) {
	...
	private boolean isAnyAnonymousResponseEqual(FeedbackQuestionsVariousAttributes question, WebElement responseView, FeedbackResponseAttributes response) {
	...
	private String getAdditionalInfoString(FeedbackQuestionsVariousAttributes question) {
	...
	private String getAnswerString(FeedbackQuestionsVariousAttributes question, FeedbackResponseDetails response) {
