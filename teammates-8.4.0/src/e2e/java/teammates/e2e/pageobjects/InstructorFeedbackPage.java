...
public abstract class InstructorFeedbackPage extends AppPage {
	...
	public void verifyQuestionDetails(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	...
	private void verifyFeedbackPathSettings(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	...
	private void verifyQuestionVisibilitySettings(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    WebElement questionForm = getQuestionForm(questionNum);
	...
	private void verifyCustomQuestionVisibility(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    WebElement questionForm = getQuestionForm(questionNum);
	    WebElement visibilityPanel = questionForm.findElement(By.tagName("tm-visibility-panel"));
	    String visibility = visibilityPanel.findElement(By.cssSelector("#btn-question-visibility span")).getText();
	...
	public void editQuestionDetails(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    clickEditQuestionButton(questionNum);
	    inputQuestionDetails(questionNum, feedbackQuestion);
	    clickSaveQuestionButton(questionNum);
	}

	private void inputQuestionDetails(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	...
	public void addTextQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(2);
	...
	public void addMcqQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(3);
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	public void addMsqQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(4);
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	public void addNumScaleQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(5);
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	public void addConstSumOptionQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(6);
	    addConstSumQuestion(feedbackQuestion);
	}

	public void addConstSumRecipientQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(7);
	    addConstSumQuestion(feedbackQuestion);
	}

	public void addConstSumQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	public void addContributionQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(8);
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	public void addRubricQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(9);
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	public void addRankOptionsQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(10);
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	public void addRankRecipientsQuestion(FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    addNewQuestion(11);
	    int questionNum = getNumQuestions();
	    inputQuestionDetails(questionNum, feedbackQuestion);
	...
	private void setFeedbackPath(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	...
	private void setQuestionVisibility(int questionNum, FeedbackQuestionsVariousAttributes feedbackQuestion) {
	    WebElement questionForm = getQuestionForm(questionNum);
	    WebElement visibilityPanel = questionForm.findElement(By.tagName("tm-visibility-panel"));
	    String visibility = visibilityPanel.findElement(By.cssSelector("#btn-question-visibility span")).getText();
