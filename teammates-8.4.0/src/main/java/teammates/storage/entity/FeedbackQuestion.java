...
public class FeedbackQuestion extends BaseEntity {
    ...
    /**
	 * @deprecated Use {@link #FeedbackQuestion(FeedbackQuestionParameter)} instead
	 */
	public FeedbackQuestion(
	        ...
	        List<FeedbackParticipantType> showRecipientNameTo) {
				this(new FeedbackQuestionParameter(feedbackSessionName, courseId, questionText, questionDescription,
						questionNumber, questionType, giverType, recipientType, numberOfEntitiesToGiveFeedbackTo,
						showResponsesTo, showGiverNameTo, showRecipientNameTo));
			}

	public FeedbackQuestion(
            FeedbackQuestionParameter feedbackquestionparameter) {

        this.feedbackQuestionId = null; // Auto-generated by Cloud Datastore
        this.feedbackSessionName = feedbackquestionparameter.feedbackSessionName;
        this.courseId = feedbackquestionparameter.courseId;
        this.questionText = feedbackquestionparameter.questionText;
        this.questionDescription = feedbackquestionparameter.questionDescription;
        this.questionNumber = feedbackquestionparameter.questionNumber;
        this.questionType = feedbackquestionparameter.questionType;
        this.giverType = feedbackquestionparameter.giverType;
        this.recipientType = feedbackquestionparameter.recipientType;
        this.numberOfEntitiesToGiveFeedbackTo = feedbackquestionparameter.numberOfEntitiesToGiveFeedbackTo;
        this.showResponsesTo = feedbackquestionparameter.showResponsesTo == null ? new ArrayList<>() : feedbackquestionparameter.showResponsesTo;
        this.showGiverNameTo = feedbackquestionparameter.showGiverNameTo == null ? new ArrayList<>() : feedbackquestionparameter.showGiverNameTo;
        this.showRecipientNameTo =
                feedbackquestionparameter.showRecipientNameTo == null ? new ArrayList<>() : feedbackquestionparameter.showRecipientNameTo;
